...
Returns: void
*/
void OptionMenu::CreateMenu(int tag, int curLanguage)
{
	...
	auto menu_item_0 = MenuItemFont::create(xmlLoader.langs[xmlLoader.CURRENT_LANG].langStrings[5], CC_CALLBACK_1(OptionMenu::PopScene, this));
	auto menu_item_1 = MenuItemFont::create(xmlLoader.langs[xmlLoader.CURRENT_LANG].langStrings[6], CC_CALLBACK_1(OptionMenu::PopScene, this));
	auto menu_item_2 = MenuItemFont::create(xmlLoader.langs[xmlLoader.CURRENT_LANG].langStrings[7], CC_CALLBACK_1(OptionMenu::PopScene, this));
	auto menu_item_3 = MenuItemFont::create(xmlLoader.langs[xmlLoader.CURRENT_LANG].langStrings[8], CC_CALLBACK_1(OptionMenu::PopScene, this));
	...
	auto *menu = Menu::create(menu_item_0, menu_item_1, menu_item_2, menu_item_3, NULL);
...
*/
void OptionMenu::PopScene(cocos2d::Ref *pSender) {
...
*/
bool OptionMenu::isKeyPressed(EventKeyboard::KeyCode code) {
...
void OptionMenu::update(float delta) {
	Node::update(delta);
...
std::map<cocos2d::EventKeyboard::KeyCode,
	std::chrono::high_resolution_clock::time_point> OptionMenu::keys;

//handles closing the program
void OptionMenu::menuCloseCallback(Ref* pSender)
{
